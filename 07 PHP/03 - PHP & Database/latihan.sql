...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4138511946ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=latihan&table=karyawan">`latihan`.`karyawan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpdasar&table=siswa">`phpdasar`.`siswa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_codepolitan&table=costumers">`db_codepolitan`.`costumers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_codepolitan&table=products">`db_codepolitan`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_codepolitan&table=items">`db_codepolitan`.`items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_codepolitan&table=orders">`db_codepolitan`.`orders`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6a743d6f6242515252687e214d5c5b59">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="latihan" targettable="karyawan">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM karyawan;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM karyawan WHERE id=&quot;51&quot;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="latihan" targettable="karyawan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM karyawan WHERE umur &lt; 21;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="latihan" targettable="karyawan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM karyawan WHERE umur &lt; 21 ORDER BY umur;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="latihan" targettable="karyawan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM karyawan WHERE umur &gt; 18 AND umur &lt; 50 ORDER BY umur;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="latihan" targettable="karyawan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM karyawan WHERE umur &gt; 18 AND umur &lt; 50 AND jenis_kelamin LIKE &quot;Male&quot; ORDER BY umur;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="latihan" targettable="karyawan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM karyawan WHERE id &gt;= 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="latihan" targettable="karyawan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO karyawan (nama, alamat, umur, jenis_kelamin) VALUES (&quot;Tono Sucipto&quot;, &quot;Surabaya&quot;, 28, &quot;P&quot;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="latihan" targettable="karyawan">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO karyawan (nama, alamat, umur, jenis_kelamin) VALUES (&quot;Tono Sucipto&quot;, &quot;Depok&quot;, 28, &quot;P&quot;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="latihan" targettable="karyawan">
                            <div class="action_content">
